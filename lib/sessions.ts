...
export const SESSIONS: Session[] = [
  ...
  },
  {
    ...
    actionPrompt:
      'Revisit your prayer list from the Pray session. Pray specifically for God to reveal which person is your "person of peace" right now. Take one step toward them this week.',
    resources: [
      { label: 'Session Slides', url: '#' },
      { label: 'DMM Community', url: 'https://network-10376509.mn.co/share/4ly4JW4EoMcWX-J-?utm_source=manual' },
    ],
